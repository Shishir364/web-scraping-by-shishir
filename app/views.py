...
def home(request):
    ...
    if 'city' in request.GET:
        ...
        result['dayhour'], result['weather_now'] = soup.find("div", attrs={"class": "BNeawe tAd8D AP7Wnd"}).text.lower().split('\n')
        
        
    return render(request, 'weather_scraping.html', {'result': result}) 